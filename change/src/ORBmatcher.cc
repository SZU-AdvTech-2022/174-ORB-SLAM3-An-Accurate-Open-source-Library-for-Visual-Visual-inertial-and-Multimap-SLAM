                    ...
                    if(bestDist1<=TH_LOW)
                    {
                        if(static_cast<float>(bestDist1)<mfNNratio*static_cast<float>(bestDist2))
                        {
                            ...
                            if(mbCheckOrientation)
                            {
                                ...
                                if (rot < -24 || rot>24) {
                                    vpMapPointMatches[bestIdxF] = static_cast<MapPoint*>(NULL);
                                    nmatches--;
                                }
                                /*if (rot<0.0)
                                    rot+=360.0f;
                ...
                for(size_t i1=0, iend1=f1it->second.size(); i1<iend1; i1++)
                {
                    ...
                    if(bestIdx2>=0)
                    {
                        ...
                        if(mbCheckOrientation)
                        {
                            ...
                            if (rot < -24 || rot>24) {
                                vbMatched2[vMatches12[idx1]] = false;
                                vMatches12[idx1] = -1;
                                nmatches--;
                            }
                           /* if (rot<0.0)
                ...
                if(!LastFrame.mvbOutlier[i])
                {
                    ...
                    if(bestDist<=TH_HIGH)
                    {
                        ...
                        if(mbCheckOrientation)
                        {
                            ...
                            if (rot < -24 || rot>24) {
                                CurrentFrame.mvpMapPoints[bestIdx2] = static_cast<MapPoint*>(NULL);
                                nmatches--;
                    ...
                    if(CurrentFrame.Nleft != -1){
                        ...
                        if(bestDist<=TH_HIGH)
                        {
                            ...
                            if(mbCheckOrientation)
                            {
                                ...
                                float rot = kpLF.angle-kpCF.angle;
                                if (rot < -24 || rot>24) {
                                    CurrentFrame.mvpMapPoints[bestIdx2+CurrentFrame.Nleft] = static_cast<MapPoint*>(NULL);
                                    nmatches--;
                ...
                if(!pMP->isBad() && !sAlreadyFound.count(pMP))
                {
                    ...
                    if(bestDist<=ORBdist)
                    {
                        ...
                        if(mbCheckOrientation)
                        {
                            ...
                            if (rot < -24 || rot>24) {
                                CurrentFrame.mvpMapPoints[bestIdx2] = NULL;
                                nmatches--;
