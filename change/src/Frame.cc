...
long unsigned int Frame::nNextId=0;//下一关键帧id
bool Frame::mbInitialComputations=true;//
float Frame::cx, Frame::cy, Frame::fx, Frame::fy, Frame::invfx, Frame::invfy;//相机的内参？
float Frame::mnMinX, Frame::mnMinY, Frame::mnMaxX, Frame::mnMaxY;//图像的边界坐标
float Frame::mfGridElementWidthInv, Frame::mfGridElementHeightInv;//网格中单元格的宽度和高度？

//For stereo fisheye matching
cv::BFMatcher Frame::BFmatcher = cv::BFMatcher(cv::NORM_HAMMING);//用于双目目鱼眼配对？
